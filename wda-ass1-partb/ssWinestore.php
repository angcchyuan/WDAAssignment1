	...
	
	{
		if (!($sYear > $eYear)){
		 if(!($minDollar > $maxDollar )){
			...
			echo "<h>SEARCH RESULT(s)  </h><table border='1'>";
		 ...
		 else {	echo "Your minimum price($) " .$minDollar. " is bigger than your maximum price($) " .$maxDollar;}
		 }
		 
		 else { echo "Your Starting year " .$sYear. " is bigger than your Eding Year " .$eYear; }
	}
